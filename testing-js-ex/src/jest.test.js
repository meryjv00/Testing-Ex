...
//-----------------------------
describe('Descuento obtenidos correctos', () => {
...
//-------------------------
describe('Puntos obtenidos correctos', () => {
    test('TDD: Se obtienen puntos del 10% del importe de la compra', () => {
    });
});

describe('Aplicación descuento libro correctos', () => {
